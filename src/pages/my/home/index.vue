...
<template>
    <div>
        <v-header title="个人中心">
                ...
                <div slot="right" class="item" flex="main:center cross:center" v-if="user.id" v-on:click="signout">
                   <i style="color:#FF0033" class="iconfont icon-signout"></i>
                </div>
         ...
         <v-content class="con">
            ...
            <nav class="nav">
                ...
                <li>
                    <router-link to="/my/collect" flex="box:justify">
                        <div class="icon" flex="cross:center">
                            <i style="color: #663300;" class="iconfont icon-collect"></i>
                        </div>
